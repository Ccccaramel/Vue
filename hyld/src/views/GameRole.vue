    ...
    <div class="container">
      <nav>
        <div class="nav nav-tabs mt-1" id="nav-tab" role="tablist">
          <button :class="id == 0 ? 'btn btn-outline-dark ms-1 active' : ' btn btn-outline-dark ms-1'" data-bs-toggle="tab"
        ...
        <div :class="id == 0 ? 'tab-pane fade show active' : 'tab-pane fade'" :id="'list-' + id" role="tabpanel" tabindex="0"
          ...
          <div class="container text-center">
            <div class="row row-cols-12">
              <div class="col col-lg-1" v-for="gameRole in gameRoleList" :key="gameRole.id">
                <div class="vstack">
                  <img class="rounded-circle" :src="gameRole.headImgUrl" @click="showGameRoleInfo(gameRole.id)">
                  <p>{{ gameRole.name }}</p>
                </div>
              </div>
            </div>
      ...
      <div class="container text-center">
        <div class="row align-items-center mb-2" v-for="(gameRolePopularity,i) in gameRolePopularityList" :key="i">
          <div class="col-1">
            <a href="/">
              <img :src="gameRolePopularity.gameRole.headImgUrl" class="rounded-2" style="height:42px;" />
            </a>
          </div>
          <div class="col-11">
            <div class="progress" style="height: 25px;">
              <div class="progress-bar progress-bar-striped  progress-bar-animated" role="progressbar"
                aria-label="Example with label" :style="'width:'+gameRolePopularity.proportion+'%;'" aria-valuenow="100" aria-valuemin="0"
      ...
      <div class="container text-center">
        <div class="row align-items-center mb-2" v-for="(gameRoleUnPopularity,i) in gameRoleUnPopularityList" :key="i">
          <div class="col-1">
            <a href="/">
              <img :src="gameRoleUnPopularity.gameRole.headImgUrl" class="rounded-2" style="height:42px;" />
            </a>
          </div>
          <div class="col-11">
            <div class="progress" style="height: 25px;">
